...
- TURBID: [Data](http://amandaduarte.com.br/turbid/), [Paper](http://amandaduarte.com.br/turbid/Turbid_Dataset.pdf).
- Underwater Color Restoration: [Data](http://csms.haifa.ac.il/profiles/tTreibitz/datasets/ambient_forwardlooking/index.html), [Paper](https://arxiv.org/abs/1811.01343), [Code](https://github.com/danaberman/underwater-hl).
...
- Underwater change detection: [Data](http://underwaterchangedetection.eu/index.html), [Paper](https://ieeexplore.ieee.org/document/7761129?denied=).
...
- Aqualoc: [Data](http://www.lirmm.fr/aqualoc/), [Paper](https://arxiv.org/abs/1910.14532).
...
- SUN Database(Scene/underwater) [Data](http://groups.csail.mit.edu/vision/SUN/).
